                ...
                children: [
                  ...
                  Container(
                    ...
                    child: CarouselSlider(
                      ...
                      items: cubit.sources.map((index) => index.results!.length).toList().map((index) {
                        return Builder(
                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) => MovieDetailScreen(
                                      movieId: cubit
                                          .sources[index].results![index].id!,
                                    ),
                                  ),
                                );
                              },
                              child: Stack(
                                children: [
                                  ClipRRect(
                                    ...
                                    child: Image.network(
                                      cubit.sources[index].results![index].posterPath!,
                                      fit: BoxFit.cover,
                                  ...
                                  Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(
                                        children: [
                                          Text(
                                            cubit.sources[index].results![index].voteAverage
                                                    ?.toStringAsFixed(1) ??
                                                '0.0',
